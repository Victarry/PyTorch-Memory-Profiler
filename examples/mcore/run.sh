...
# Running for silicon
# TODO: running with PP will hang, need to debug
export CUDA_DEVICE_MAX_CONNECTIONS=1
torchrun --nproc_per_node=8 --nnodes=1 pretrain_gpt.py --model moe --tp-size 2 --pp-size 1 --ep-size 2 --ga 8 > silicon.log 2>&1
...
python pretrain_gpt.py --tp-size 2 --pp-size 1 --ep-size 2 --ga 8 --estimated --model moe > estimated.log 2>&1
